...
#pragma HLS BIND_STORAGE variable = dict type = RAM_T2P impl = BRAM
#pragma HLS ARRAY_PARTITION variable = dict cyclic factor=2 dim=1
...
//#endif
#pragma HLS dependence variable = dict inter false
#pragma HLS dependence variable = dict intra false
#pragma HLS dependence variable = present_window inter false
